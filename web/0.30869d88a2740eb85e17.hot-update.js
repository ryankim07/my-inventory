...
var VehicleForm = function (_React$Component) {
    ...
    _createClass(VehicleForm, [{
        ...
        value: function _onChange() {
            this.setState({ mfgs: _vehiclesStore2.default.getMfgs() });
        }
    }, {
        key: 'handleChange',
        ...
        value: function render() {
            var makes = this.state.mfgs.makes;
            var mfgsHtml = void 0;
            var yearsHtml = [];

            mfgsHtml = this.state.mfgs.map(function (mfg) {
                var makes = mfg.makes;
                makes.map(function (make) {
                    return _react2.default.createElement(
                        'option',
                        { key: make.id, value: make.name },
                        make.name
                    );
                });
            });
