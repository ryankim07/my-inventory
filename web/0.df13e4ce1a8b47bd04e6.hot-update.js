...
var VehicleForm = function (_React$Component) {
    ...
    _createClass(VehicleForm, [{
        ...
        value: function componentWillMount() {
            _vehiclesStore2.default.addChangeListener(this._onChangeMfg.bind(this));
        }
    }, {
        ...
        value: function componentWillUnmount() {
            _vehiclesStore2.default.removeChangeListener(this._onChangeMfg.bind(this));
        }
    }, {
        key: '_onChangeMfg',
        value: function _onChangeMfg() {
        ...
        value: function render() {
            ...
            mfgsHtml = this.state.manufacturers.map(function (mfgs) {});
