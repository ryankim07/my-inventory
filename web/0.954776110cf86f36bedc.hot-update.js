...
var VehicleForm = function (_React$Component) {
    ...
    _createClass(VehicleForm, [{
        ...
        value: function handleChange(propertyName, event) {
            ...
            if (propertyName == 'vin') {
                vehicle[propertyName] = event.target.value.upperCase();
            } else {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'model'), value: this.state.vehicle.model, className: 'form-control input-sm required' })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'year'), value: this.state.vehicle.year, className: 'form-control input-sm required' })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'color'), value: this.state.vehicle.color, className: 'form-control input-sm required' })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'vin'), value: this.state.vehicle.vin, className: 'form-control input-sm required' })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group' },
                            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange.bind(this, 'plate'), value: this.state.vehicle.plate, className: 'form-control input-sm required' })
                        )
                    )
                ),
                _react2.default.createElement(
