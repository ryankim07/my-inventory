...
var MfgOptions = function (_React$Component) {
    _inherits(MfgOptions, _React$Component);

    function MfgOptions() {
        _classCallCheck(this, MfgOptions);

        return _possibleConstructorReturn(this, (MfgOptions.__proto__ || Object.getPrototypeOf(MfgOptions)).apply(this, arguments));
    }

    _createClass(MfgOptions, [{
        key: 'render',
