...
var AppRoot = function (_React$Component) {
    ...
    function AppRoot(props) {
        ...
        var _this2 = _possibleConstructorReturn(this, (AppRoot.__proto__ || Object.getPrototypeOf(AppRoot)).call(this, props));
    ...
    _createClass(AppRoot, [{
        ...
        value: function componentWillUnmount() {
            _vehiclesStore2.default.removeChangeListener(this._onChange);
        }
    }, {
        key: 'removeVehicle',
        ...
        value: function _onChange() {
            console.log('setting vehicles' + Math.random());
            this.setState({ vehicles: 'Test' });
