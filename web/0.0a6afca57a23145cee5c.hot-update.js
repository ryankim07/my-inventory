...
var AllVehicles = function (_React$Component) {
    _inherits(AllVehicles, _React$Component);

    function AllVehicles(props) {
        _classCallCheck(this, AllVehicles);

        var _this = _possibleConstructorReturn(this, (AllVehicles.__proto__ || Object.getPrototypeOf(AllVehicles)).call(this, props));
